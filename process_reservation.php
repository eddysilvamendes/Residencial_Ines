...
if (!$errors && !$missing) {
    ...
    $replacements = [
        'info@ilhadomaio.it'  =>
            ['#subject#' => 'Pedido de Reserva RESIDENCIAL Inês']

        $email =>
            ['#subject#' => 'RESIDENCIAL Inês Reservation Request',
    ...
    try {
        ...
        $message = Swift_Message::newInstance()
            ...
            $image_ilha = $message->embed(Swift_Image::fromPath('assets/img/maio.png'));
...
center">Pedido de Reserva RESIDENCIAL Inês</h1>
</td>
</tr>
<tr>
